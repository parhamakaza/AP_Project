...
public class Buttons {
    ...
    public static Button makeButton (String s ,double h, double w, double lx, double ly){
        Button button = makeButton(s , lx , ly);
        button.setLayoutY(h - button.getPrefHeight()/2);
        button.setLayoutX(h - button.getPrefWidth()/2);
